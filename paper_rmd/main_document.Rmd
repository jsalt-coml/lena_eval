...
Finally, for AWC, we fit a mixed model where AWC according to the human was predicted from AWC according to LENA^TM^, in interaction with corpus and age, as fixed factors, declaring child ID as random effect. As with CTC, an Analysis of Variance (type 3) found no main effects or interactions. 
