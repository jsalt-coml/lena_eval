...
labels = c("SIL", "CHI", "OCH", "FEM", "MAL", "ELE", "OVL")
...
plot1 = plot(gold1_CV_count~gold2_CV_count,data=data,pch=20,col=alpha("black",.2),xlab="Human 2",ylab="Human 1",xlim=myrange,ylim=myrange, main="Level of agreement on \n CV_count") + abline(lm(gold1_CV_count~gold2_CV_count,data=data)) + abline(lm(gold1_CV_count~gold2_CV_count,data=data,subset=c(data$gold2_CV_count>0 & data$gold1_CV_count>0)),lty=2)
...
abline(lm(gold1_CNV_count~gold2_CNV_count,data=data,subset=c(data$gold2_CNV_count>0 & data$gold1_CNV_count>0)),lty=2)
...
abline(lm(gold1_CTC_count~gold2_CTC_count,data=data,subset=c(data$gold2_CTC_count>0 & data$gold1_CTC_count>0)),lty=2)
```

```{r, echo=FALSE, message=FALSE}
par(mfrow=c(1,2))
myrange=range(data[,c("gold1_CV_cum_dur","gold2_CV_cum_dur")],na.rm=T)
plot1 = plot(gold1_CV_cum_dur~gold2_CV_cum_dur,data=data,pch=20,col=alpha("black",.2),xlab="Human 2",ylab="Human 1",xlim=myrange,ylim=myrange, main="Level of agreement on \n CV_cum_dur") + abline(lm(gold1_CV_cum_dur~gold2_CV_cum_dur,data=data)) + abline(lm(gold1_CV_cum_dur~gold2_CV_cum_dur,data=data,subset=c(data$gold2_CV_cum_dur>0 & data$gold1_CV_cum_dur>0)),lty=2)

myrange=range(data[,c("gold1_CNV_cum_dur","gold2_CNV_cum_dur")],na.rm=T)
plot3 = plot(gold1_CNV_cum_dur~gold2_CNV_cum_dur,data=data,pch=20,col=alpha("black",.2),xlab="Human 2",ylab="Human 1",xlim=myrange,ylim=myrange, main="Level of agreement \n on CNV_cum_dur") +
abline(lm(gold1_CNV_cum_dur~gold2_CNV_cum_dur,data=data)) +
abline(lm(gold1_CNV_cum_dur~gold2_CNV_cum_dur,data=data,subset=c(data$gold2_CNV_cum_dur>0 & data$gold1_CNV_cum_dur>0)),lty=2)
